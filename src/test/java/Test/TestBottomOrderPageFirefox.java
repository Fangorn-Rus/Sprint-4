...
public class TestBottomOrderPageFirefox {
    ...
    public TestBottomOrderPageFirefox(String name, String surname, String address, String stationName, String phoneNumber,
